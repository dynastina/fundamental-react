// // akses ke html
const root = document.getElementById("root"); // // create element
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "Simple Todo List"), /*#__PURE__*/React.createElement("form", {
    ...
    type: "submit"
  }, edit.id ? 'Update' : 'Tambah'), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: removeAllTodoHandler
  }, "Hapus Semua")), /*#__PURE__*/React.createElement("ul", null, todo.map(item => {
    ...
    }, item.title), "\xA0\xA0\xA0", /*#__PURE__*/React.createElement("button", {
